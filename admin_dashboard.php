...
if ($_SESSION['role'] !== 'admin' || $_SESSION['email'] !== 'admin@gmail.com') {
    echo "<script>alert('Access denied! Only the main admin can access this page.'); window.location.href='home.php';</script>";
    exit();
}
...
if (isset($_GET['del'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        echo "<script>alert('Recipe deleted successfully!'); window.location.href='admin_dashboard.php';</script>";
    } else {
        echo "<script>alert('Failed to delete recipe. Try again.');</script>";
    }
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this recipe?")) {
                window.location.href = 'admin_dashboard.php?del=' + id;
            }
        }
    </script>
</head>
<body>
    <div class="container my-5">
        <h2 class="text-center">Admin Dashboard - Recipe Book</h2>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    echo '</td>
                            <td>
                                <a class="btn btn-outline-danger btn-sm" href="javascript:void(0);" onclick="confirmDelete(' . htmlspecialchars($row["Id"]) . ')">Delete</a>
                            </td>
                        </tr>';
                    }
                    ?>
